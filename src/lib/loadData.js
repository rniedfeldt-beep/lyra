...
export { default as wildShapeUsesPerDayTable } from '../data/tables/wildShapeUsesPerDay.json'
export { default as classSkillsTable } from '../data/tables/classSkills.json'
